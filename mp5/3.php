  ...
  function getAnswer(){
    ...
    if (isNaN(guess)) {
      switch (guess){
        ...
        case ('human'):
          alert("You're normal!");
          window.location="4.php?1=<?php echo $_GET['1']?>&2=<?php echo $_GET['2']?>&3=correct";
          break;
        default:
          alert("You're an addict!");
          window.location="4.php?1=<?php echo $_GET['1']?>&2=<?php echo $_GET['2']?>&3=wrong";
          break;
      }
    } else if (tries>=2){
...
<div class="img">
  <a>
    <img src="img/human.jpg" alt="Test1" width="500" height="600">
  </a>
